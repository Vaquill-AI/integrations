...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/projects/projectId/conversations/sessionId/messages/promptId \
...
```bash
curl --request PUT \
     --url https://app.vaquill.ai/api/v1/projects/projectId/conversations/sessionId/messages/promptId/feedback \
     --header 'accept: application/json' \
