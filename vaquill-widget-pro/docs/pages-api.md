...
```bash
curl --request GET \
     --url 'https://app.vaquill.ai/api/v1/projects/projectId/pages?page=1&limit=20&order=desc&crawl_status=all&index_status=all' \
...
```bash
curl --request DELETE \
     --url https://app.vaquill.ai/api/v1/projects/projectId/pages/pageId \
     --header 'accept: application/json'
```
...
```bash
curl --request POST \
     --url https://app.vaquill.ai/api/v1/projects/projectId/pages/pageId/reindex \
     --header 'accept: application/json'
```
...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/preview/id \
     --header 'accept: application/json'
```
