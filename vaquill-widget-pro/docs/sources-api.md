...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/projects/projectId/sources \
...
```bash
curl --request PUT \
     --url https://app.vaquill.ai/api/v1/projects/projectId/sources/sourceId \
     --header 'accept: application/json' \
...
```bash
curl --request PUT \
     --url https://app.vaquill.ai/api/v1/projects/projectId/sources/sourceId/instant-sync \
     --header 'accept: application/json'
```
