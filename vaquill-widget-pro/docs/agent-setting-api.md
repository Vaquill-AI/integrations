...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/projects/projectId/settings \
...
```json
{
  ...
  "data": {
    ...
    "persona_instructions": "You are a custom agent assistant called Vaquill.ai, a friendly lawyer who answers questions based on the given context.",
