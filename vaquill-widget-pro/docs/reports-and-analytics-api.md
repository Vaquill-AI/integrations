...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/projects/projectId/reports/traffic \
...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/projects/projectId/reports/queries \
     --header 'accept: application/json'
```
...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/projects/projectId/reports/conversations \
     --header 'accept: application/json'
```
...
```bash
curl --request GET \
     --url 'https://app.vaquill.ai/api/v1/projects/projectId/reports/analysis?interval=weekly' \
     --header 'accept: application/json'
```
