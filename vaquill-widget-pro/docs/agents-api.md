...
```bash
curl --request GET \
     --url 'https://app.vaquill.ai/api/v1/projects?page=1&order=desc&orderBy=id&width=100%25&height=auto' \
...
```bash
curl --request POST \
     --url https://app.vaquill.ai/api/v1/projects \
     --header 'accept: application/json' \
...
```bash
curl --request GET \
     --url 'https://app.vaquill.ai/api/v1/projects/projectId?width=100%25&height=auto' \
     --header 'accept: application/json'
```
...
```bash
curl --request POST \
     --url https://app.vaquill.ai/api/v1/projects/projectId \
     --header 'accept: application/json' \
     --header 'content-type: multipart/form-data' \
...
```bash
curl --request POST \
     --url https://app.vaquill.ai/api/v1/projects/projectId/replicate \
     --header 'accept: application/json'
```
...
```bash
curl --request GET \
     --url https://app.vaquill.ai/api/v1/projects/projectId/stats \
     --header 'accept: application/json'
```
